...
import 'package:io_extended_2023_gdg_la_paz/src/ui/pages/onboarding/controller/onboarding_controller.dart';
...
class _OnboardingPageState extends State<OnboardingPage> {
  ...
  void _changePage() {
    onboardingController.changePage(_pageController.page?.toInt());
  }
          ...
          child: Consumer<OnboardingController>(
            builder: (context, OnboardingController, child) {
              final isLastOnboardingPage =
                  OnboardingController.pageIndex == onboardingItems.length - 1;
      ...
      builder: (context, OnboardingController, child) {
        return AnimatedContainer(
          ...
          decoration: BoxDecoration(
            color: OnboardingController.pageIndex == pageIndex
                ? AppColors.primary
                : AppColors.shadow,
